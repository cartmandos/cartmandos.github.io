const AVATAR_ELEMENT_ID = "avatar";
const NAME_ELEMENT_ID = "profile-name";

/* GitHub APIs base url */
const GITHUB_USERS_API = "https://api.github.com/users";
const GITHUB_REPOS_API = "https://api.github.com/repos";

/* GitHub required path params for GET user method
path: '{username}' 
*/
const GITHUB_USERNAME = "cartmandos";

/* GitHub required path params for GET repo method */
